...
@if exist %ffmpegpath% (
  %ffmpegpath% -i %1 -f mp4 -filter:v hqdn3d=4.0:3.0:6.0:4.5 -sws_flags lanczos -c:v libx265 -crf 21 -preset medium -c:a aac -strict -2 -b:a 128k "%~d1%~p1%~n1_anyp265.mp4"
) else (
